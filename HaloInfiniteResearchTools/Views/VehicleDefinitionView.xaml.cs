...
{
    /// <summary>
    /// Interaction logic for VehicleDefinitionView.xaml
    /// </summary>
    public partial class VehicleDefinitionView : View<VehicleDefinitionViewModel>
    {
        public VehicleDefinitionView()
        {
            InitializeComponent();
        }
        void initRenderModelView()
        {
            try
            {
                ...
                VehicleDefinitionViewModel temp = (this.DataContext as VehicleDefinitionViewModel);
        ...
        {
            var viewModel = DataContext as VehicleDefinitionViewModel;
