...
namespace HaloInfiniteResearchTools.Processes
{
    ...
    public abstract class ProcessBase : IProcess
    {
        ...
        protected ProcessBase(IServiceProvider? serviceProvider)
        {
            ...
            _cancelCts = new CancellationTokenSource();
            CancelCommand = new FireOnceCommand(Cancel);
            _serviceProvider = serviceProvider == null ? ((App)App.Current).ServiceProvider : serviceProvider;
        }
    ...
    {
        protected ProcessBase(IServiceProvider? serviceProvider) : base(serviceProvider)
        {
        }

        protected ProcessBase() : base()
        {
        }
