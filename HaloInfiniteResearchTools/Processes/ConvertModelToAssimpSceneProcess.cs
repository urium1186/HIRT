...
namespace LibHIRT.Processes
{
    ...
    public class ConvertModelToAssimpSceneProcess : ProcessBase<Scene>
    {
        ...
        public ConvertModelToAssimpSceneProcess(ISSpaceFile file, bool forceCanel = false)
        {
            _file = file;
            _statusLock = new object();
            _forceCanel = forceCanel;
        }
        ...
        private async Task<SceneContextNew> DeserializeFile()
        {
            ...
            try
            {
                ...
                if (_file is RenderModelFile)
                {
                    ...
                    var context = new SceneContextNew( tpl, stream, StatusList);
    ...
    internal class SceneContextNew
    {
        ...
        public SceneContextNew(RenderModelDefinition tpl, HIRTStream stream, StatusList statusList)
        {
            this.tpl = tpl;
            this.stream = stream;
    ...
    internal class MeshBuilderNew {
        ...
        private void AddVertices(MeshLOD meshLOD)
        {
            ...
            {
                Mesh.Vertices.Add(vertex.Position.ToAssimp3D());
