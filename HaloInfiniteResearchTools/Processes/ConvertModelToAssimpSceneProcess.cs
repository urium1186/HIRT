...
namespace LibHIRT.Processes
{
    ...
    public class ConvertModelToAssimpSceneProcess : ProcessBase<Scene>
    {
        ...
        private SceneContextNew _context;
        ...
        public ConvertModelToAssimpSceneProcess(ISSpaceFile file, Scene parentScene = null, Assimp.Matrix4x4 initialTransform = default)
        {
            _file = file;
      ...
      if ( armatureNode != null )
        ...
        private async Task<SceneContextNew> DeserializeFile()
        {
            ...
            try
            {
                ...
                if (_file is RenderModelFile)
                {
                    ...
                    var context = new SceneContextNew(tpl, stream, StatusList, _parentScene);
        ...
        private void AddSubMeshes(ObjMesh obj)
        {
            ...
            //foreach (var submesh in obj.SubMeshes)
            //{
            var builder = new MeshBuilderNew(_context, obj, null);
    ...
    internal class SceneContextNew
    {
        ...
        public Dictionary<short, MeshBuilderNew> SkinCompounds { get; }
        public RenderModelDefinition Tpl { get => tpl; set => tpl = value; }

        public SceneContextNew(RenderModelDefinition tpl, HIRTStream stream, StatusList statusList, Scene _parentScene = null)
        {
            this.tpl = tpl;
            this.stream = stream;
    ...
    internal class SceneContext
    {
        ...
        public SceneContext(S3DGeometryGraph graph, HIRTStream stream, StatusList statusList)
        {
            StatusList = statusList;
    ...
    internal class MeshBuilderNew
    {
        private readonly SceneContextNew _context;
