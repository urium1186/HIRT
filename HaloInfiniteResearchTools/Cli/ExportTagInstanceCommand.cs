               ...
               new Command("onpath", "Search in folder path")
                   {
                    ...
                    new Option<string?>(new string[] { "--jsonplus", "-jp" }, "True or Folse, create a ligt json or complex"),
                    new Option<string?>(new string[] { "--consoleout", "-co" }, "True or Folse, create a ligt json or complex"),
               ...
               new Command("onmodule", "Search in module")
                   {
                    ...
                    new Option<string?>(new string[] { "--consoleout", "-co" }, "true or false, create a ligt json or complex"),
            }.Also(cmd => cmd.SetHandler(
