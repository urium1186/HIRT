...
{
    public delegate void FileEntryProcessorOld(HiModuleFileEntry? fileEntry);
    public class HiModuleOld
    {
        ...
        public void ReadIn(BinaryReader binaryReader)
        {
            ...
            for (int i = 0; i < moduleHeader.FilesCount; i++)
            {
                ...
                HiModuleFileEntry entry = new(null);
            ...
            if (test_out_range)
            {
                ...
                Debug.Assert(moduleHeader.MapRefIndex == 0);
            ...
            Debug.Assert(1 == moduleHeader.MapRefIndex || 0 == moduleHeader.MapRefIndex || moduleHeader.MapRefIndex == -1);
